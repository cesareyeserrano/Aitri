...
5. `docs/guides/GETTING_STARTED.md` - end-to-end onboarding from zero installation
6. `docs/AGENT_EXECUTION_CHECKLIST.md` - runtime contract for agents
...
11. `docs/runbook/DEMO_5_MINUTES.md` - reproducible <=5 minute end-to-end demo
12. `docs/runbook/PERSONA_INTERACTION_FLOW.md` - role boundaries and multi-pass persona flow
13. `backlog/aitri-core/backlog.md` - prioritized next-improvement backlog
14. `docs/templates/deploy/` - deployment plan/checklist templates
