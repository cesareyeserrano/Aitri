  ...
  validate(content, ctx = {}) {
    ...
    if (mustLinkedStoriesNoAC.length)
      throw new Error(
        ...
        `give each ≥1 acceptance criterion (Given/When/Then with concrete values is the target). ` +
