...
export default {
  ...
  validate(content) {
    ...
    const BROAD_VAGUE = /\b(good|nice|beautiful|pretty|clean|fast|smooth|properly|correctly|efficiently|reliably|appropriately|securely|safely|effectively|adequately|seamlessly)\b/i;
