...
// Pure result-file parser, reused so --evidence can mechanically confirm a claim
// when the evidence is a TRX/JUnit-XML file (verify.js does not import tc.js — no cycle).
import { parseXmlResults } from './verify.js';
