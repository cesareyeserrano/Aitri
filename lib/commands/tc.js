...
import { loadConfig, saveConfig, artifactPath, readArtifactFile, atomicWrite } from '../state.js';
...
function tcVerify({ dir, args, flagValue, err, featureRoot, scopeName }) {
  ...
  if (!notes || !notes.trim())
    err(`--notes is required — describe what you observed during manual execution.\n  Example: ${c.tcVerify} TC-002f --result pass --notes "pip freeze 3.12 vs 3.14 difiere en 8 paquetes"`);
