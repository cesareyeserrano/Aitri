...
export function cmdRunPhase({ dir, args, flagValue, err, rootDir, featureRoot }) {
  const raw      = args[0];
  ...
  console.log(p.buildBriefing({ dir, inputs, feedback, failingTests, artifactsBase, bestPractices }));
