...
export function cmdFeature({ dir, args, err, rootDir }) {
  ...
  switch (sub) {
    ...
    // tc verify / mark-manual on the FEATURE's own 03_TEST_CASES.json /
    // 04_TEST_RESULTS.json (FEAT-PARITY-0620). featureCtx.args is already the
    // post-name remainder (e.g. ['verify','TC-001','--result','pass']), and
    // featureCtx.dir is the feature dir, so cmdTC operates on the feature artifacts.
