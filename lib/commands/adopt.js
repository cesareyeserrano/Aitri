...
import { loadConfig, saveConfig, artifactPath, readArtifact, hashArtifact, clearDriftPhase, appendEvent, configExists } from '../state.js';
...
function adoptUpgrade({ dir, VERSION, rootDir, dryRun = false }) {
  return runUpgrade({ dir, VERSION, rootDir, dryRun });
}
