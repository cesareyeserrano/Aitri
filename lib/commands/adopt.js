...
import { loadConfig, saveConfig, artifactPath, readArtifact, hashArtifact, clearDriftPhase, appendEvent, configExists, ideaPath as resolveIdeaPath, backlogMdPath } from '../state.js';
...
function adoptScan({ dir, VERSION, err }) {
  ...
  process.stderr.write(
    ...
    `   2. Agent creates ADOPTION_SCAN.md (diagnostic) and IDEA.md (adoption plan)\n` +
