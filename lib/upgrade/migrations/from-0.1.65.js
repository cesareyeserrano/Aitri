...
import { artifactPath, hashArtifact, appendEvent, seedArchiveDir, seedPath as seedPathOf } from '../../state.js';
...
function diagnoseLegacyVenvManifest(dir, config) {
  ...
  for (const e of entries) {
    ...
    const rel = path.posix.join('features', e.name, featArtifactsDir, '04_BUILD_REPORT.json');
